...
- Devuelve una función anónima que realiza una operación [bitwise _and_][bitwise-wiki] usando el argumento pasado a la función anónima y el argumento pasado a `Secret.secret_and/1`
- Las funciones en el [módulo Bitwise][bitwise-hexdocs] pueden ser útiles.
- Si está ejecutando Elixir versión 1.9 o anterior, deberá llamar a `require Bitwise` al comienzo de la definición del módulo para poder usar el módulo _Bitwise_.
